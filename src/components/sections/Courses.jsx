        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
          <div className="max-w-xl">
            ...
            <p className="text-slate-500 text-lg">
              اكتشف تخصصاتنا المصممة بعناية لتلبية تطلعاتك الدراسية والوصول الي اعلي المستويات في كل المواد.مش بس في في المناهج المصرية لا هناك مناهج كويته وسعوديةواماراتية 
            </p>
          </div>
